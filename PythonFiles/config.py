...
data_root = '/home/ubuntu/mmdetection/data/'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file='/home/ubuntu/mmdetection/data/chunk.json',
        img_prefix='/home/ubuntu/mmdetection/data/',
...
log_level = 'INFO'
work_dir = '/home/ubuntu/mmdetection/work_dir'
load_from = None
resume_from = None
workflow = [('train', 1)]
